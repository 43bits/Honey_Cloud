...
export default function Header({ total, isLive, criticalCount }: Props) {
  ...
  return (
    <header className="relative z-10 flex items-center px-5 py-3 border-b border-cyan-500/20 bg-black/40 backdrop-blur-sm">
      ...
      {/* Right — LIVE badge + time + button */}
      <div className="flex items-center ml-auto gap-3">
        {/* LIVE/CONNECTING + UTC time grouped */}
        <div className="flex items-center gap-2">
          ...
          <div className="text-[10px] font-mono text-cyan-500/50 whitespace-nowrap">{time}</div>
        </div>

        {/* Button — pinned to far right */}
