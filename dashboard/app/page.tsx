  ...
  return (
    <div className="relative z-10 min-h-screen flex flex-col">
      ...
      <div className="flex-1 p-3 space-y-3">
        ...
        {/* ── Map + Charts row (resizable width) ── */}
        <div
          ref={rowRef}
        ...
        >
          {/* Map panel */}
          <div className="relative flex-shrink-0" style={{ width: `${mapPct}%` }}>
            <Suspense fallback={
              <div
          ...
          {/* Charts panel */}
          <div className="flex-1 overflow-hidden" style={{ width: `${rightPct}%` }}>
            <Charts
              topAttackTypes={stats.top_attack_types}
              topPorts={stats.top_ports}
              topCountries={stats.top_countries}
        ...
        <div
          ...
          className="flex items-center justify-center
            cursor-row-resize select-none h-4"
